    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="text-center flex-1">
                <h1 class="text-4xl font-bold text-gray-800">Market Stall Portal</h1>
                <p class="text-xl text-gray-600 mt-2">Welcome, <?= htmlspecialchars($full_name) ?>! Manage your market stall activities.</p>
            </div>
        ...
        <!-- Additional Back to Dashboard Button at Bottom -->
        <div class="text-center mt-8">
            <button onclick="location.href='../dashboard.php'" 
                    class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 inline-flex items-center space-x-2">
