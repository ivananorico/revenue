    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center">
                ...
                <a href="../../../revenue/api/business_user/business_dashboard.php" class="w-full md:w-auto bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
